  ...
  <div class="w3-dropdown-hover">
    ...
    <div class="w3-top">
      <div class="w3-bar w3-white w3-wide w3-padding w3-card">
        <a href="../home.php" class="4w3-bar-item w3-button" ><b>PLATES</b> of JOYS</a>
    ...
    <div class="comments-container">
        ...
        <?php
                        ...
                        $query = "SELECT * FROM feedback f, visitor r WHERE f.visitorid = r.visitorid AND languageid = 5001";
