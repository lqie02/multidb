...
<table class="content-table" border="0" cellspacing="30" width="60%" align="center">
    ...
    $img1sql = "SELECT * from image i, content c, audio a ,video v WHERE i.CONTENTID = c.CONTENTID AND a.CONTENTID = c.CONTENTID AND v.CONTENTID = c.CONTENTID AND c.LANGUAGEID =5001 LIMIT 5,5";
