...
<div class="w3-sidebar w3-bar-block w3-card" style="width:16%;right:0; margin-top:-6px; font-size: 20px; ">
  ...
  <a href="chinese/chinese.php?id=5003" class="w3-bar-item w3-button">Chapter</a>
  <a href="chinese/assessment.php?id=5003" class="w3-bar-item w3-button">Assessment</a>
  <a href="chinese/result.php" class="w3-bar-item w3-button">Result</a>
  <a href="chinese/feedback.php?id=5003" class="w3-bar-item w3-button">Feedback</a>
