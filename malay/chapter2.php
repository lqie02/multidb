...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
	...
	<h1><center>Chapter 2  <span class="cn">(Bab 2)</span></center></h1>
...
<table class="content-table" border="0" cellspacing="30" width="60%" align="center">
    ...
    $img1sql = "SELECT * from image i, content c, audio a,video v WHERE i.CONTENTID = c.CONTENTID AND a.CONTENTID = c.CONTENTID AND v.CONTENTID = c.CONTENTID AND c.LANGUAGEID =5002 LIMIT 5,5";
...
<a href="chinese.php?id=5003" class="button">Finish</a>
