...
<div class="w3-top">
	...
	<center><h1>Assessment 1 <span class="qz"> / Penilaian 1</span></h1></center>
	<br>
	<center><h3>Level: Easy</h3></center>
	
	<div class="card mb-3">
	<?php
    $quizsql = "SELECT * from questiontable q, image i WHERE q.imageid = i.imageid AND assid = '".$assid."' AND questionID > $questionID LIMIT 1";
    $quizresult = mysqli_query($conn,$quizsql);
		...
		if ($quizresult && mysqli_num_rows($quizresult)>0)
		{
			...
			{ ?>
					...
					<form action="evaluateeasy.php" method="POST" >
						<div class="card-body">
