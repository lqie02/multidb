...
<section id="blog">
  ...
  <div class="blog-container">
    ...
    <div class="blog-box">
      <div class="blog-img">
      <img src="../image/girl.png" alt="chapter1">
    </div>
    <div class="blog-text">
      <span><b>Chapter 1</b></span>
      <p>Learning about the Chinese Cuisine</p>
      <a href="chapter1.php?id=5002"><i class="fa fa-external-link" aria-hidden="true"></i> &nbsp;Learn More</a>
    </div>
    </div>
     ...
     <div class="blog-box">
      <div class="blog-img">
      <img src="../image/ketupat.png" alt="chapter2">
    </div>
    <div class="blog-text">
      <span><b>Chapter 2</b></span>
      <p>Learning about the Malay Cuisine</p>
      <a href="chapter2.php?id=5002"><i class="fa fa-external-link" aria-hidden="true"></i>&nbsp; Learn More</a>
    </div>
    </div> 
    ...
    <!--box 3-->
     <div class="blog-box">
      <div class="blog-img">
      <img src="../image/biryani.png" alt="chapter3">
    </div>
    <div class="blog-text">
      <span><b>Chapter 3</b></span>
      <p>Learning about the Indian Cuisine</p>
      <a href="chapter3.php?id=5002"><i class="fa fa-external-link" aria-hidden="true"></i>&nbsp; Learn More</a>
    </div>
    </div> 
